...
extension UIFont {
    ...
    static func verdana20() -> UIFont {
        return UIFont(name: "Verdana", size: 20) ?? UIFont.systemFont(ofSize: 20, weight: .bold)
    }
    
    static func verdana14() -> UIFont {
        return UIFont(name: "Verdana", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .bold)
    }
    
    static func verdana12() -> UIFont {
        return UIFont(name: "Verdana", size: 12) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
    }
    
    static func verdana10() -> UIFont {
        return UIFont(name: "Verdana", size: 10) ?? UIFont.systemFont(ofSize: 10, weight: .bold)
    }
